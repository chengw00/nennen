...
set CODE = /model/chengw/dpg/analog/ztmp/analog_code_parallel/anen
...
# ====
echo "add $MPI/bin before mpif90 in configure before executing configure"
#
# ======= this works for parallel ========
